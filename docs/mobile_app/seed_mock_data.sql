-- Run this in the Supabase SQL editor to add/update development mock data.
-- The app code does not seed these rows automatically.
...
values
  ('d7392b1c-d247-46a6-b39c-18b5f8dceb6b', 'Track 1', 'Main indoor net', true),
  ('74aed49b-736a-42c4-b227-ce6d68c2c75d', 'Track 2', 'Practice indoor net', true)
...
values
  ('10000000-0000-4000-8000-000000000001', 'd7392b1c-d247-46a6-b39c-18b5f8dceb6b', '06:00', '08:00', 'weekday', 700, 'LKR', '2026-05-01', '2026-12-31', true),
  ('10000000-0000-4000-8000-000000000002', 'd7392b1c-d247-46a6-b39c-18b5f8dceb6b', '08:00', '12:00', 'weekday', 900, 'LKR', '2026-05-01', '2026-12-31', true),
  ('10000000-0000-4000-8000-000000000003', 'd7392b1c-d247-46a6-b39c-18b5f8dceb6b', '16:00', '22:00', 'weekday', 1300, 'LKR', '2026-05-01', null, true),
  ('10000000-0000-4000-8000-000000000004', '74aed49b-736a-42c4-b227-ce6d68c2c75d', '06:00', '12:00', 'weekday', 800, 'LKR', '2026-05-01', null, true),
  ('10000000-0000-4000-8000-000000000005', '74aed49b-736a-42c4-b227-ce6d68c2c75d', '16:00', '22:00', 'weekend', 1500, 'LKR', '2026-05-01', null, true)
on conflict (id) do update set
...
values
  ('30000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', 'd7392b1c-d247-46a6-b39c-18b5f8dceb6b', '2026-05-16', '18:00', '18:30', 1300, 'active'),
  ('30000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000001', 'd7392b1c-d247-46a6-b39c-18b5f8dceb6b', '2026-05-16', '18:30', '19:00', 1300, 'active'),
  ('30000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000001', 'd7392b1c-d247-46a6-b39c-18b5f8dceb6b', '2026-05-16', '19:00', '19:30', 1300, 'active'),
  ('30000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000001', 'd7392b1c-d247-46a6-b39c-18b5f8dceb6b', '2026-05-16', '19:30', '20:00', 1300, 'active'),
  ('30000000-0000-4000-8000-000000000005', '20000000-0000-4000-8000-000000000002', '74aed49b-736a-42c4-b227-ce6d68c2c75d', '2026-05-16', '07:00', '07:30', 800, 'active'),
  ('30000000-0000-4000-8000-000000000006', '20000000-0000-4000-8000-000000000002', '74aed49b-736a-42c4-b227-ce6d68c2c75d', '2026-05-16', '07:30', '08:00', 800, 'active'),
  ('30000000-0000-4000-8000-000000000007', '20000000-0000-4000-8000-000000000002', '74aed49b-736a-42c4-b227-ce6d68c2c75d', '2026-05-16', '08:00', '08:30', 600, 'active'),
  ('30000000-0000-4000-8000-000000000008', '20000000-0000-4000-8000-000000000002', '74aed49b-736a-42c4-b227-ce6d68c2c75d', '2026-05-16', '08:30', '09:00', 600, 'active'),
  ('30000000-0000-4000-8000-000000000009', '20000000-0000-4000-8000-000000000003', 'd7392b1c-d247-46a6-b39c-18b5f8dceb6b', '2026-05-17', '20:00', '20:30', 1500, 'active'),
  ('30000000-0000-4000-8000-000000000010', '20000000-0000-4000-8000-000000000003', 'd7392b1c-d247-46a6-b39c-18b5f8dceb6b', '2026-05-17', '20:30', '21:00', 1500, 'active'),
  ('30000000-0000-4000-8000-000000000011', '20000000-0000-4000-8000-000000000003', 'd7392b1c-d247-46a6-b39c-18b5f8dceb6b', '2026-05-17', '21:00', '21:30', 1500, 'active'),
  ('30000000-0000-4000-8000-000000000012', '20000000-0000-4000-8000-000000000004', '74aed49b-736a-42c4-b227-ce6d68c2c75d', '2026-05-18', '19:00', '19:30', 1500, 'released'),
  ('30000000-0000-4000-8000-000000000013', '20000000-0000-4000-8000-000000000004', '74aed49b-736a-42c4-b227-ce6d68c2c75d', '2026-05-18', '19:30', '20:00', 1500, 'released')
on conflict (id) do update set
...
values
  ('60000000-0000-4000-8000-000000000001', 'd7392b1c-d247-46a6-b39c-18b5f8dceb6b', '2026-05-16', '21:00', '21:30', 'Maintenance', '00000000-0000-4000-8000-000000000001', '2026-05-16 09:30:00+05:30'),
  ('60000000-0000-4000-8000-000000000002', 'd7392b1c-d247-46a6-b39c-18b5f8dceb6b', '2026-05-16', '21:30', '22:00', 'Maintenance', '00000000-0000-4000-8000-000000000001', '2026-05-16 09:30:00+05:30'),
  ('60000000-0000-4000-8000-000000000003', '74aed49b-736a-42c4-b227-ce6d68c2c75d', '2026-05-17', '09:30', '10:00', 'Staff Training', '00000000-0000-4000-8000-000000000001', '2026-05-16 09:30:00+05:30'),
  ('60000000-0000-4000-8000-000000000004', '74aed49b-736a-42c4-b227-ce6d68c2c75d', '2026-05-17', '10:00', '10:30', 'Staff Training', '00000000-0000-4000-8000-000000000001', '2026-05-16 09:30:00+05:30')
on conflict (id) do update set
  track_id = excluded.track_id,
  slot_date = excluded.slot_date,
  start_time = excluded.start_time,
